...
ini          =  xbmc.translatePath(os.path.join('special://home/addons/plugin.video.mafiastreams/resources/ivue','mafiastreams.ini'))
inizip       = 	xbmc.translatePath(os.path.join('special://home/addons/plugin.video.mafiastreams/resources/ivue','plugin.video.mafiastreams.zip'))
tmpini       =  xbmc.translatePath(os.path.join('special://home/userdata',''))
ivuetarget   =  xbmc.translatePath(os.path.join('special://home/userdata/addon_data/script.ivueguide/resources/ini/plugin.video.mafiastreams'))
def iVueInt():
	xbmc.executebuiltin("ActivateWindow(busydialog)")
	dp = xbmcgui.DialogProgress()
	dp.create("mafiastreams","Copying ini",'', 'Please Wait')
	...
	iVueSet = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.mafiastreams/resources/ivue','ivuesettings.xml'))
	iVueFold = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.mafiastreams/resources/ivue'))
	...
	dp = xbmcgui.DialogProgress()
	dp.create("mafiastreams","Copying DB",'', 'Please Wait')
...
def install(name,url):
    ...
    dp = xbmcgui.DialogProgress()
    dp.create("mafiastreams","Installing iVue TV Guide...",'', 'Please Wait')
