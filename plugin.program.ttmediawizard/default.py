...
def viewBuild(name):
	...
	if name in Protected:
		...
		U_Data	=	wiz.getKeyboard(base64.b64decode(b''), base64.b64decode(b'QVJFIFlPVSBXT1JUSFkgT0YgTVkgQlVJTEQuLi4uRU5URVIgUEFTU1dPUkQhIQ'))
		...
		if U_Data == S_Data:
			...
			DIALOG.ok(base64.b64decode(b'UGFzc3dvcmQgQ2hlY2sgRmFpbGVkIQ'),base64.b64decode(b'SU5DT1JSRUNUIFBBU1NXT1JELi4uLllPVSBBUkUgTk9UIFdPUlRIWSE'))
