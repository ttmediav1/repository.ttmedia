...
def Get():
	...
	m3u  = 'http://thepk.co:2086//get.php?username='+username+'&password='+password+'&type=m3u_plus&output=ts'
	epg  = 'http://thepk.co:2086//xmltv.php?username='+username+'&password='+password+'&type=m3u_plus&output=ts'
	auth = 'thepk.co:2086//enigma2.php?username='+username+'&password='+password+'&type=get_vod_categories'
	...
	if not auth=="":
		...
		xbmcgui.Dialog().ok('Cable','[COLOR blue]M3U URL: [/COLOR]%s'%shortm3u,'','[COLOR blue]EPG URL: [/COLOR]%s'%shortepg)
	else:
		return