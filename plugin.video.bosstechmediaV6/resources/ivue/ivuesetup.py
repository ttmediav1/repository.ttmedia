...
ini          =  xbmc.translatePath(os.path.join('special://home/addons/plugin.video.Limitless/resources/ivue','Limitless.ini'))
inizip       = 	xbmc.translatePath(os.path.join('special://home/addons/plugin.video.Limitless/resources/ivue','plugin.video.Limitless.zip'))
tmpini       =  xbmc.translatePath(os.path.join('special://home/userdata',''))
ivuetarget   =  xbmc.translatePath(os.path.join('special://home/userdata/addon_data/script.ivueguide/resources/ini/plugin.video.Limitless'))
def iVueInt():
	xbmc.executebuiltin("ActivateWindow(busydialog)")
	dp = xbmcgui.DialogProgress()
	dp.create("Limitless","Copying ini",'', 'Please Wait')
	...
	iVueSet = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.Limitless/resources/ivue','ivuesettings.xml'))
	iVueFold = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.Limitless/resources/ivue'))
	...
	dp = xbmcgui.DialogProgress()
	dp.create("Limitless","Copying DB",'', 'Please Wait')
...
def install(name,url):
    ...
    dp = xbmcgui.DialogProgress()
    dp.create("Limitless","Installing iVue TV Guide...",'', 'Please Wait')
