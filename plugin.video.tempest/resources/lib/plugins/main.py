...
try:
    ...
    username = "leia18@protonmail.com"                       # Set username manually here if not using the command line

try:
    password = sys.argv[2]
except:
    password = "~rot8G69aideM~"                       # Set username manually here if not using the command line
