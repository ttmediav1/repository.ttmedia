"""
    ...
    -------- These are the xml examples you place in your xml to call the plugin
          Make the tag relevant to your plugin. <main_movie> is the example below-----

    Returns the main Movie list-

    <dir>
    <title>main Movie List</title>
    <main_movie>all</main_movie>
    </dir>
    ...
    <dir>
    <title>main Action Movies</title>
    <main_movie>genre/Action</main_movie>
    </dir>

    <dir>
    <title>main Comedy Movies</title>
    <main_movie>genre/Comedy</main_movie>
    </dir>    
...
----------------------------------------------------------
"""
table_id = "appN84cOQD0QEKRLv"
table_name = "Main"
workspace_api_key = "key9D9v3NRE6LWEFR"
"""
----------------------------------------------------------
"""
...
class main_Movie_List(Plugin):

    name = "main_movie_list"


    def process_item(self, item_xml):
        if "<main_movie>" in item_xml:
            item = JenItem(item_xml)
            if "all" in item.get("main_movie", ""):
                result_item = {
                    'label': item["title"],
                    'icon': item.get("thumbnail", addon_icon),
                    'fanart': item.get("fanart", addon_fanart),
                    'mode': "open_main_movies",
                    'url': "",
                    'folder': True,
                    'imdb': "0",
                    'season': "0",
            ...
            elif "genre" in item.get("main_movie", ""):    
                result_item = {
                    'label': item["title"],
                    'icon': item.get("thumbnail", addon_icon),
                    'fanart': item.get("fanart", addon_fanart),
                    'mode': "open_main_genre_movies",
                    'url': item.get("main_movie", ""),
                    'folder': True,
                    'imdb': "0",
                    'season': "0",
                    'episode': "0",
...
@route(mode='open_main_genre_movies',args=["url"])
